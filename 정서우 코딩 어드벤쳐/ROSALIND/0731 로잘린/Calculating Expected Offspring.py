...
# spaced outcomes has the same probability is called a uniform random variable (in the die example,
# this "equal spacing" is equal to 1). We can generalize our die example to find that if X
